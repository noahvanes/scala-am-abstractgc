class AAMRefCountingKont[Exp : Expression, Abs : JoinLattice, Addr : Address, Time : Timestamp]
    extends EvalKontMachine[Exp, Abs, Addr, Time] {
  def name = "AAMRefCountingKont"
  ...
  case class State(control: Control, store: RefCountingStoreVanilla[Addr, Abs], kstore: RefCountingKontStore[Addr,KontAddr], adr: KontAddr, t: Time) {
